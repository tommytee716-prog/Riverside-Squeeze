  ...
  return (
    <div style={{ marginBottom: 12 }}>
      {!playing ? (
        ...
        <button className="music-btn music-btn-playing" onClick={handleStop}>
          ⏹ Stop Music
        </button>
      )}
      {visible && (
    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .music-open-btn { font-size: 11px; color: #1DB954; border: 1px solid rgba(29,185,84,0.3); padding: 5px 10px; border-radius: 999px; text-decoration: none; white-space: nowrap; font-weight: 600; background: rgba(29,185,84,0.08); }
